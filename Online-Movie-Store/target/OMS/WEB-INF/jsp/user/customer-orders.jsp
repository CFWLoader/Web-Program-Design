...
<head>
    ...
    <!-- theme stylesheet -->
    <link href="<%=AppContext.getBaseUrl()%>/resource/stylesheets/obaju-css/style.default.css" rel="stylesheet"
          id="theme-stylesheet">
    ...
    <div class="container">
        ...
        <div class="navbar-buttons">
            ...
            <div class="navbar-collapse collapse right" id="basket-overview">
                <a href="<%=AppContext.getBaseUrl()%>/basket" class="btn btn-primary navbar-btn"><i
