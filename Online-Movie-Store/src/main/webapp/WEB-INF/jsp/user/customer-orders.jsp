        ...
        <div class="container">
            ...
            <div class="navbar-buttons">
                ...
                <div class="navbar-collapse collapse right" id="basket-overview">
                    <a href="<%=AppContext.getBaseUrl()%>/basket" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="hidden-sm">3 items in cart</span></a>
                </div>
                <!--/.nav-collapse -->
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        ...
                        <ul>
                            ...
                            <li><a href="<%=AppContext.getBaseUrl()%>/user/register">Register</a>
                            </li>
                        </ul>
