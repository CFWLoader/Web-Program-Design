            ...
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<%=AppContext.getBaseUrl()%>/order/customer-orders" method="post">
                        ...
                        <p class="text-center text-muted"><a href="<%=AppContext.getBaseUrl()%>/user/registerPage"><strong>Register now</strong></a>! It is easy and done in 1&nbsp;minute and gives you access to special discounts and much more!</p>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <div class="navbar-buttons">
                    ...
                    <a class="btn btn-default navbar-toggle" href="<%=AppContext.getBaseUrl()%>/basket">
                                ...
                                <div class="yamm-content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <h5>Order process</h5>
                                            <ul>
                                                <li><a href="<%=AppContext.getBaseUrl()%>/basket">Shopping cart</a>
                                                </li>
            ...
            <div class="navbar-buttons">
                ...
                <div class="navbar-collapse collapse right" id="basket-overview">
                    <a href="<%=AppContext.getBaseUrl()%>/basket" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="hidden-sm">${itemCount} items in cart</span></a>
                </div>
                <!--/.nav-collapse -->
