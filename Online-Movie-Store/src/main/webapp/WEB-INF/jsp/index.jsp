        ...
        <div id="content">
            ...
            <div class="container">
                <div class="col-md-12">
                    <div id="main-slider">
                        <div class="item">
                            <img src="<%=AppContext.getBaseUrl()%>/resource/images/obaju-img/main-slider1.jpg" alt="" class="img-responsive">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="<%=AppContext.getBaseUrl()%>/resource/images/obaju-img/main-slider2.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="<%=AppContext.getBaseUrl()%>/resource/images/obaju-img/main-slider3.jpg" alt="">
                        </div>
                        <div class="item">
                            <img class="img-responsive" src="<%=AppContext.getBaseUrl()%>/resource/images/obaju-img/main-slider4.jpg" alt="">
                        </div>
                    </div>
                    <!-- /#main-slider -->
                </div>
                ...
                <div class="col-md-12">
                    <div class="box slideshow">
                        ...
                        <div id="get-inspired" class="owl-carousel owl-theme">
                            <div class="item">
                                <a href="#">
                                    <img src="<%=AppContext.getBaseUrl()%>/resource/images/obaju-img/getinspired1.jpg" alt="Get inspired" class="img-responsive">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="<%=AppContext.getBaseUrl()%>/resource/images/obaju-img/getinspired2.jpg" alt="Get inspired" class="img-responsive">
                                </a>
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img src="<%=AppContext.getBaseUrl()%>/resource/images/obaju-img/getinspired3.jpg" alt="Get inspired" class="img-responsive">
                                </a>
                            </div>
                        </div>
                    </div>
