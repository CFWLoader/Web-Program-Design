...
import './App.css';
import {AndersonDarling, KolmogorovSmirnov} from './mylib/statistic_test';
    ...
    return (
      <table>
        ...
        <tbody>
          <tr>
            <td>Uniform</td>
            <td>{AndersonDarling.pValueUniform(this.getData())}</td>
            <td>{KolmogorovSmirnov.pValueUniform(this.getData())}</td>
          </tr>
          <tr>
            <td>Normality</td>
            <td>{AndersonDarling.pValueNormal(this.getData())}</td>
            <td>{KolmogorovSmirnov.pValueNormal(this.getData())}</td>
          </tr>
          <tr>
            <td>Log-Normality</td>
            <td>{AndersonDarling.pValueLogNormal(this.getData())}</td>
            <td>{KolmogorovSmirnov.pValueLogNormal(this.getData())}</td>
          </tr>
          <tr>
            <td>Triangle</td>
            <td>N/A</td>
          ...
          <tr>
            <td>Gamma</td>
            <td>{AndersonDarling.pValueGamma(this.getData())}</td>
            <td>{KolmogorovSmirnov.pValueGamma(this.getData())}</td>
          </tr>
          <tr>
            <td>Beta</td>
            <td>N/A</td>
          ...
          <tr>
            <td>Weibull</td>
            <td>{AndersonDarling.pValueWeibull(this.getData())}</td>
            <td>{KolmogorovSmirnov.pValueWeibull(this.getData())}</td>
          </tr>
        </tbody>
      </table>
      // <div className="App">
